...
<article class="col-sm-12 col-md-6 col-lg-8 left">
    ...
    <div class="xnews2">
        ...
        <div class="dec">
			...
			foreach ($arr as $k=>$v) {
                echo "<a href='http://blog.tp5.com/index.php/index/search/index?keywords=$v'>$v</a>";
                }
                ?>
            </div>
        </div>
